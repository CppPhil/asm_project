...
all: main.o eprintf.o tests.o memchr_asm.o memset_asm.o memcpy_asm.o strlen_asm.o
	$(CC) $(CFLAGS) -o application main.o eprintf.o tests.o memchr_asm.o memset_asm.o memcpy_asm.o strlen_asm.o
main.o: ./src/main.c
